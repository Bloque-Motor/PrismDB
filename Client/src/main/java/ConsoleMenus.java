...
class ConsoleMenus {
    ...
    private static void editUserMenu(Map<People.keyType, String> res) throws RemoteException {
        ...
        System.out.println("Nombre: " + data[0] + "/" + res.get(People.keyType.NAME));
        System.out.println("Apellidos: " + data[1] + "/" + res.get(People.keyType.SURNAME));
        System.out.println("DNI: " + data[2] + "/" + res.get(People.keyType.DNI));
        System.out.println("Teléfono: " + data[3] + "/" + res.get(People.keyType.PHONE));
        System.out.println("E-mail: " + data[4] + "/" + res.get(People.keyType.EMAIL));
